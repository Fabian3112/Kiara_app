...
class SideLungeLeftCount : TrainEvaluation{
    ...
    let angles_steps : [[angleStep]] = [
        ...
        [angleStep(lower_angle: 70, higer_angle: 110, angle: .left_knee),   //left knee bound 90 Degrees
    ...
    let step_messages : [String] = ["step left food to the side","step back", "Well Done"]
